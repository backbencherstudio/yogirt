...
//     if (!isScrolling.current && sectionRef.current) {
...
//       const newIndex = Math.min(Math.floor( relativeScrollY / contentHeight), totalContent - 1);
...
//         // Sync the custom scrollbar
//         if (scrollRef.current) {
//           const customScrollHeight = scrollRef.current.scrollHeight / totalContent;
//           scrollRef.current.scrollTo({
//             top: newIndex * customScrollHeight,
//             behavior: 'smooth'
//           });
//         }
...
//         // Sync the window scroll
//         if (sectionRef.current) {
//           const section = sectionRef.current;
//           const sectionTop = section.offsetTop;
//           const windowContentHeight = (section.scrollHeight - window.innerHeight) / totalContent;


//           window.scrollTo({
//             top: sectionTop  + (newIndex * windowContentHeight ),
//             behavior: 'smooth'
//           });
//         }
...
//       <div className=" lg:py-[100px]  lg:pt-[150px] xl:pt-[200px] pt-[80px] sm:pt-[90px] md:pt-[100px] lg:pb-[200px] max-w-[1320px] mx-auto px-4 2xl:px-0  min-h-[400vh]  relative z-0 font-plexs section-container" ref={sectionRef}>
...
//                 className="w-[8%]  lg:h-[90%] self-center overflow-y-scroll custom-scroll2 custom-scroll-container"
//               >
...
const Chooses = () => {
  ...
  return (
    <div className="bg-[#032124] " >
      <div className=" lg:py-[100px]  lg:pt-[150px] xl:pt-[200px] pt-[80px] sm:pt-[90px] md:pt-[100px] lg:pb-[200px] max-w-[1320px] mx-auto px-4 2xl:px-0  min-h-[300vh]  relative z-0 font-plexs section-container" ref={sectionRef}>
        <div className=" sticky-0 sticky top-0">
          <div className=" ">
            <div className="">
              <div className="text-[#12C6D8] uppercase xl:w-[1021px]">
