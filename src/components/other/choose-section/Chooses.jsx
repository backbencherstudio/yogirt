      ...
      >
        <div className="lg:sticky lg:top-0 lg:h-screen ">
          ...
          <div className="lg:flex hidden lg:h-96 xl:mt-[100px] lg:mt-[60px] mt-[42px]  ">
            ...
            {/* Custom Scrollbar */}
            <div className="relative w-[8%]  lg:h-[90%] custom-scroll2  ">
              <div
                ref={scrollbarRef}
              ...
              >
                ...
                {/* {content.map(( index) => (
                  <div
                    key={index}
                    className={`absolute -right-2 w-1 h-1 transform -translate-y-1/2 ${index <= safeActiveIndex ? 'bg-cyan-400' : 'bg-cyan-400/20'
                      }`}
                    style={{
