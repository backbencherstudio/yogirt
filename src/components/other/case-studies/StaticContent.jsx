        ...
        <div className=""> 
            ...
            <div className="case-id-two sm:mt-24 mt-14">
                ...
                <div className="context-div mt-6">
                    ...
                    <div className="button-containerNew">
                   <button onClick={() => { setIsModalOpen(true); handleIndex(1) }} className="  corner-buttonNew uppercase corner-btn-bg text-[16px] lg:text-[18px] font-[500] text-white px-[18px]  md:px-[24px]  lg:px-[30px] mt-6" style={{backgroundColor:"rgba(18, 198, 216, 0.15)"}} ><span>View Full Project</span></button>
                   </div>
                </div>
            </div>
            <div className="case-id-three sm:mt-24 mt-14">
                ...
                <div className="context-div mt-6">
                    ...
                    <div className="button-containerNew">
                   <button onClick={() => { setIsModalOpen(true); handleIndex(2) }} className="  corner-buttonNew uppercase corner-btn-bg text-[16px] lg:text-[18px] font-[500] text-white px-[18px]  md:px-[24px]  lg:px-[30px] mt-6" style={{backgroundColor:"rgba(18, 198, 216, 0.15)"}} ><span>View Full Project</span></button>
                   </div>
                </div>
            </div>
